...
{
    internal class ClsJogodados:UIElement
    {
        public int Montante
        {
        ...
        public static readonly DependencyProperty Dado1Property =
            DependencyProperty.Register("Dado1", typeof(int), typeof(ClsJogodados), new PropertyMetadata(4));
        ...
        public static readonly DependencyProperty Dado2Property =
            DependencyProperty.Register("Dado2", typeof(int), typeof(ClsJogodados), new PropertyMetadata(6));
        ...
        public void rolar(int aposta)
        {
            ...
            if (aposta > 0)
            {
                ...
                Dado1 = r.Next(1, 7);
                Dado2 = r.Next(1, 7);
                if (Dado1 == Dado2) DisparaOnPremio(aposta);
            }
        }

        //Criar evento

        private static readonly RoutedEvent OnPremioEvent = EventManager.RegisterRoutedEvent(
           "OnPremio",
        ...
        public void DisparaOnPremio(int aposta)
        {
